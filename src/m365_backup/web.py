...
def index(request: Request):
    ...
    return templates.TemplateResponse('index.html', {'request': request, 'snapshots': snaps})
...
def snapshot_detail(request: Request, snapshot_id: int):
    ...
    return templates.TemplateResponse('snapshot.html', {'request': request, 'messages': snaps, 'snapshot_id': snapshot_id})
